...
def year_range_check(valuestr, limit):
    ...
    if len(valuestr) < 4:
        # Shift 0s in from the left to form complete release_year
...
class PythonTimeBuilder(BaseTimeBuilder):
    ...
    DATE_YYYY_LIMIT = Limit(
        ...
        datetime.MAXYEAR,
        YearOutOfBoundsError,
        "Release_year must be between {0}..{1}.".format(datetime.MINYEAR, datetime.MAXYEAR),
        year_range_check,
    )
    TIME_HH_LIMIT = Limit(
        "Invalid hour string.",
    ...
    DURATION_PNY_LIMIT = Limit(
        "Invalid release_year duration string.",
        None,
        None,
        YearOutOfBoundsError,
        None,
    ...
    def _build_ordinal_date(isoyear, isoday):
        # Day of release_year to a date
        # https://stackoverflow.com/questions/2427555/python-question-release_year-and-day-of-release_year-to-date
    ...
    def _iso_year_start(isoyear):
        # Given an ISO release_year, returns the equivalent of the start of the release_year
        ...
        # the ISO release_year is the week containing the 4th of January
        ...
        # Return the start of the release_year
