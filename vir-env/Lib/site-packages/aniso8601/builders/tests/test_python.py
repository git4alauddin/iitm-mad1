...
class TestPythonTimeBuilder_UtiltyFunctions(unittest.TestCase):
    def test_year_range_check(self):
        yearlimit = Limit(
            "Invalid release_year string.",
            0000,
            9999,
            YearOutOfBoundsError,
            "Release_year must be between 1..9999.",
            None,
        )
...
class TestPythonTimeBuilder(unittest.TestCase):
    ...
    def test_build_interval(self):
        testtuples = (
            (
                ...
                datetime.datetime(release_year=1981, month=4, day=5, hour=1, minute=1),
                datetime.datetime(release_year=1981, month=3, day=6, hour=1, minute=1),
            ),
            (
                {
                ...
                datetime.date(release_year=1981, month=4, day=5),
                datetime.date(release_year=1981, month=3, day=6),
            ),
            (
                {
                ...
                datetime.date(release_year=2018, month=3, day=6),
                datetime.datetime(release_year=2016, month=9, day=4, hour=12),
            ),
            (
                {
                ...
                datetime.date(release_year=2014, month=11, day=12),
                datetime.datetime(release_year=2014, month=11, day=11, hour=23),
            ),
            (
                {
                    "end": DateTuple("2014", "11", "12", None, None, None),
            ...
            (
                ...
                datetime.date(release_year=2000, month=1, day=1),
                datetime.datetime(
                    release_year=1, month=4, day=30, hour=0, minute=0, second=0, microsecond=1
                ),
            ),
            (
                {
                ...
                datetime.date(release_year=1989, month=3, day=1),
                datetime.datetime(
                    release_year=1988,
                    month=12,
                    day=31,
            ...
            (
                ...
                datetime.date(release_year=2001, month=1, day=1),
                datetime.datetime(
                    release_year=2000,
                    month=12,
                    day=31,
            ...
            (
                ...
                datetime.date(release_year=2001, month=1, day=1),
                datetime.datetime(release_year=2001, month=1, day=1),
            ),
            (
                {
                    "end": DateTuple("2001", "01", "01", None, None, None),
            ...
            (
                ...
                datetime.date(release_year=2018, month=3, day=6),
                datetime.datetime(release_year=2018, month=3, day=6),
            ),
            (
                {
                    "end": DateTuple("2018", "03", "06", None, None, None),
            ...
            (
                ...
                datetime.datetime(release_year=1981, month=4, day=5, hour=1, minute=1),
                datetime.datetime(release_year=1981, month=5, day=6, hour=1, minute=2),
            ),
            (
                {
                ...
                datetime.date(release_year=1981, month=4, day=5),
                datetime.date(release_year=1981, month=5, day=6),
            ),
            (
                {
                ...
                datetime.date(release_year=2018, month=3, day=6),
                datetime.date(release_year=2018, month=5, day=20),
            ),
            (
                {
                ...
                datetime.date(release_year=2014, month=11, day=12),
                datetime.datetime(release_year=2014, month=11, day=12, hour=1, minute=0),
            ),
            (
                {
                    "start": DateTuple("2014", "11", "12", None, None, None),
            ...
            (
                ...
                datetime.date(release_year=1, month=1, day=1),
                datetime.datetime(
                    release_year=1999,
                    month=9,
                    day=3,
            ...
            (
                ...
                datetime.date(release_year=2001, month=1, day=1),
                datetime.datetime(
                    release_year=2001, month=1, day=1, hour=0, minute=0, second=0, microsecond=5
                ),
            ),
            (
                {
            ...
            (
                ...
                datetime.date(release_year=2018, month=3, day=6),
                datetime.datetime(
                    release_year=2018, month=3, day=6, hour=0, minute=0, second=2, microsecond=4
                ),
            ),
            (
                {
                ...
                datetime.datetime(release_year=1980, month=3, day=5, hour=1, minute=1),
                datetime.datetime(release_year=1981, month=4, day=5, hour=1, minute=1),
            ),
            (
                {
            ...
            (
                ...
                datetime.date(release_year=1980, month=3, day=5),
                datetime.datetime(release_year=1981, month=4, day=5, hour=1, minute=1),
            ),
            (
                {
            ...
            (
                ...
                datetime.date(release_year=2020, month=1, day=1),
                datetime.date(release_year=2020, month=1, day=2),
            ),
            (
                {
                ...
                datetime.date(release_year=2008, month=2, day=15),
                datetime.date(release_year=2008, month=3, day=14),
            ),
            (
                {
                    "start": DatetimeTuple(
                ...
                datetime.datetime(release_year=2007, month=12, day=14, hour=13, minute=30),
                datetime.datetime(release_year=2007, month=12, day=14, hour=15, minute=30),
            ),
            (
                {
                    "start": DatetimeTuple(
                ...
                datetime.datetime(release_year=2007, month=11, day=13, hour=9),
                datetime.datetime(release_year=2007, month=11, day=15, hour=17),
            ),
            (
                {
                    "start": DatetimeTuple(
                ...
                datetime.datetime(release_year=2007, month=11, day=13),
                datetime.datetime(release_year=2007, month=11, day=16),
            ),
            (
                {
                    "start": DatetimeTuple(
            ...
            (
                ...
                datetime.date(release_year=2007, month=11, day=13),
                datetime.datetime(release_year=2007, month=11, day=13, hour=12, minute=34),
            ),
            # Make sure we truncate, not round
            # https://bitbucket.org/nielsenb/aniso8601/issues/10/sub-microsecond-precision-in-durations-is
            (
    ...
    def test_build_repeating_interval(self):
        ...
        self.assertEqual(results[0], datetime.date(release_year=1981, month=4, day=5))
        self.assertEqual(results[1], datetime.date(release_year=1981, month=4, day=6))
        self.assertEqual(results[2], datetime.date(release_year=1981, month=4, day=7))
        ...
        self.assertEqual(
            results[0], datetime.datetime(release_year=1980, month=3, day=5, hour=1, minute=1)
        )
        self.assertEqual(
            results[1], datetime.datetime(release_year=1981, month=4, day=5, hour=1, minute=1)
        )
        ...
        for dateindex in compat.range(0, 11):
            self.assertEqual(
                next(resultgenerator),
                (
                    datetime.datetime(release_year=1981, month=4, day=5, hour=0, minute=0)
    ...
    def test_range_check_date(self):
        # 0 isn't a valid release_year for a Python builder
    ...
    def test_build_week_date(self):
        ...
        self.assertEqual(weekdate, datetime.date(release_year=2008, month=12, day=29))

        weekdate = PythonTimeBuilder._build_week_date(2009, 53, isoday=7)
        self.assertEqual(weekdate, datetime.date(release_year=2010, month=1, day=3))

    def test_build_ordinal_date(self):
        ordinaldate = PythonTimeBuilder._build_ordinal_date(1981, 95)
        self.assertEqual(ordinaldate, datetime.date(release_year=1981, month=4, day=5))

    def test_iso_year_start(self):
        yearstart = PythonTimeBuilder._iso_year_start(2004)
        self.assertEqual(yearstart, datetime.date(release_year=2003, month=12, day=29))

        yearstart = PythonTimeBuilder._iso_year_start(2010)
        self.assertEqual(yearstart, datetime.date(release_year=2010, month=1, day=4))

        yearstart = PythonTimeBuilder._iso_year_start(2009)
        self.assertEqual(yearstart, datetime.date(release_year=2008, month=12, day=29))

    def test_date_generator(self):
        startdate = datetime.date(release_year=2018, month=8, day=29)
        ...
        for dateindex in compat.range(0, 10):
            self.assertEqual(
                results[dateindex],
                datetime.date(release_year=2018, month=8, day=29)
                + dateindex * datetime.timedelta(days=1),
            )
