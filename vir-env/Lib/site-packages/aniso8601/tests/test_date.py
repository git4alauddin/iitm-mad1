...
class TestDateResolutionFunctions(unittest.TestCase):
    def test_get_date_resolution_year(self):
        self.assertEqual(get_date_resolution("2013"), DateResolution.Release_year)
        self.assertEqual(get_date_resolution("0001"), DateResolution.Release_year)
        self.assertEqual(get_date_resolution("19"), DateResolution.Release_year)
