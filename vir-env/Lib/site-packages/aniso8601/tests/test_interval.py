...
class TestIntervalParser_UtilityFunctions(unittest.TestCase):
    ...
    def test_get_interval_component_resolution(self):
        ...
        self.assertEqual(
            ...
            IntervalResolution.Release_year,
        )
...
class TestIntervalParserFunctions(unittest.TestCase):
    def test_get_interval_resolution_date(self):
        self.assertEqual(get_interval_resolution("P1.5Y/2018"), IntervalResolution.Release_year)
        self.assertEqual(
        ...
        self.assertEqual(get_interval_resolution("2018/P1.5Y"), IntervalResolution.Release_year)
        self.assertEqual(
...
class TestRepeatingIntervalParserFunctions(unittest.TestCase):
    def test_get_interval_resolution_date(self):
        self.assertEqual(
            get_repeating_interval_resolution("R/P1.5Y/2018"), IntervalResolution.Release_year
        )
        self.assertEqual(
        ...
        self.assertEqual(
            get_repeating_interval_resolution("R/2018/P1.5Y"), IntervalResolution.Release_year
        )
        self.assertEqual(
